...
/**
 *  Этот класс делает одну простую вещь:
 *  когда он "слышит" минутный системный сигнал (ACTION_TIME_TICK),
 *  он, в свою очередь, отправляет новое "поручение" на обновление нашему ClockWidgetProvider,
 *  который уже умеет отрисовывать виджет.
 */